...
<html>
    ...
    <section style="background-color: black;" id="services" class="section">
        ...
        <div class="col-sm-6 text-center-mobile">
                    ...
                    <h3 style="color: pink;">¡Gracias por preferirnos!</h3>
                    <h3 style="color: lightblue;"> El equipo llegara a ti en un empaque de tamaño: <?php echo filter_input( INPUT_GET, 'monitor', FILTER_SANITIZE_URL ); ?></h3>
