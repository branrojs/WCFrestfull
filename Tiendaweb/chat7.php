...
<html>
    ...
    <section style="background-color: black;" id="services" class="section">
        ...
        <div class="col-sm-6 text-center-mobile">
                    ...
                    <h3 class="bounceInDown animated" style="color: greenyellow;">Felicidades te espera una nueva maquina <?php echo filter_input( INPUT_GET, 'marca', FILTER_SANITIZE_URL ); ?></h3>
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-offset-6 text-center-mobile">
                                    <form name="monitor Input Form" action="chat8.php">
