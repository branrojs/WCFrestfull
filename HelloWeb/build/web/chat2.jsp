...
<html>
    ...
    <section style="background-color: black;" id="services" class="section">
		...
		<div class="col-sm-6 text-center-mobile">
                    ...
                    <jsp:setProperty name="mybean" property="tipo" />
                    <h1 class="bounceInDown animated" style="color: yellow;">¡Una <jsp:getProperty name="mybean" property="tipo" /> excelente!</h1>
			...
			<div class="row">
				<div class="col-sm-6 col-lg-offset-6 text-center-mobile">
                                    <form name="tipo Input Form" action="chat3.jsp">
