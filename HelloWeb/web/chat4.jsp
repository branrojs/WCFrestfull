...
<html>
    ...
    <section style="background-color: black;" id="services" class="section">
		...
		<div class="col-sm-6 text-center-mobile">
                    ...
                    <jsp:setProperty name="mybean" property="cpu" />
                    <h2 class="bounceInDown animated" style="color: red;">El procesador es un <jsp:getProperty name="mybean" property="cpu" /></h2>
			...
			<div class="row">
				<div class="col-sm-6 col-lg-offset-6 text-center-mobile">
                                    <form name="cpu Input Form" action="chat5.jsp">
